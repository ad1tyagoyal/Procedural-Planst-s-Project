...
public class TerrainFace {
    ...
    public TerrainFace(int resolution, Mesh mesh, Vector3 localUp) {
            ...
            for(int y = 0; y < m_Resolution; y++) {
                for(int x = 0; x < m_Resolution; x++) {
                    ...
                    if(x != (m_Resolution - 1) && y != (m_Resolution - 1)) {
                        triangleIndices[triangleIndex]          = verticesIndex + 1; 
                        triangleIndices[triangleIndex + 1]      = verticesIndex + m_Resolution + 1; 
                        triangleIndices[triangleIndex + 2]      = verticesIndex + m_Resolution; 
                        
                        triangleIndices[triangleIndex + 3]      = verticesIndex + m_Resolution; 
                        triangleIndices[triangleIndex + 4]      = verticesIndex; 
                        triangleIndices[triangleIndex + 5]      = verticesIndex + 1; 
